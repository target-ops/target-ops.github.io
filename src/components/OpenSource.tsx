      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[420px] overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-surface-elevated to-transparent z-10 pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-surface-elevated to-transparent z-10 pointer-events-none"></div>
            ...
            <div className="animate-scroll-vertical space-y-4">
              ...
              {featuredProjects.map((project, index) => {
                ...
                return (
                  <Card key={`first-${index}`} className="p-5 bg-card border-border hover:border-primary/50 transition-all">
              ...
              {featuredProjects.map((project, index) => {
                const Icon = project.icon;
                return (
                  <Card key={`second-${index}`} className="p-5 bg-card border-border hover:border-primary/50 transition-all">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                        <Icon className="h-6 w-6 text-primary" />
                      </div>
